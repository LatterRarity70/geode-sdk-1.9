...
$register_ids(OptionsLayer) {
	...
	optionsLayer->getChildByType<cocos2d::CCLabelBMFont>(labelOffset)->setID("record-replays-label");
	labelOffset++;
#endif
...
#ifdef GEODE_IS_MOBILE
	vaultMenu->getChildByType<CCMenuItemToggler>(0)->setID("record-replays-toggle");
#endif
